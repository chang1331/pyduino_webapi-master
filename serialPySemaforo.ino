 ...
 */
const int LED_ROJO_COCHE = 6;
const int LED_AMBAR_COCHE = 7;
const int LED_VERDE_COCHE = 8;
const int LED_ROJO_PEATON = 4;
...
void digital_boton(){
     ...
     */
    Serial.println(cont); // Adds a trailing \n
}
